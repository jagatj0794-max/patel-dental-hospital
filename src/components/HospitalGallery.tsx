...
import { MediaImage } from '../pages/SmileGallery';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredImages.map((img, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-[0_5px_16px_rgba(0,0,0,0.20)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.30)] hover:-translate-y-1 transition-all duration-300 group cursor-pointer flex flex-col"
                >
