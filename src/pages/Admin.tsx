    ...
    <div id="admin-panel-container" className="min-h-[calc(100vh-72px)] bg-slate-50 font-sans flex flex-col lg:flex-row relative">
      ...
      {editingService && (
        <div className="fixed inset-0 z-[140] bg-slate-50 flex flex-col overflow-hidden animate-fade-in" id="service-editor-page">
          ...
          ) : editingService.slug === 'root-canal-treatment' || editingService.id === 'rct' ? (
            /* Custom Full-Scale CMS Editor for Single Sitting Root Canal */
            <div className="relative bg-white flex-grow flex flex-col w-full h-full">
              {/* Header */}
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 hidden sm:block">
                    <h3 className="font-display font-extrabold text-[#081C3A] text-xs leading-tight">
                      Edit Single Sitting Root Canal CMS
                    </h3>
                    <p className="text-slate-500 text-[10px] font-medium mt-0.5 truncate flex items-center gap-1">
                      <span className="font-mono text-slate-700">{editingService.id}</span>
                    </p>
              ...
              <div className="flex-1 overflow-y-auto bg-slate-50/50 p-6">
                <div className="max-w-6xl mx-auto pb-12">
                  <RootCanalCms onSaveSuccess={loadServicesList} />
                </div>
              </div>
            </div>
          ) : editingService.slug === 'full-mouth-rehabilitation' || editingService.id === 'fmr-srv' || editingService.id === 'fullmouth' ? (
            /* Custom Full-Scale CMS Editor for Full Mouth Rehabilitation */
            <div className="relative bg-white flex-grow flex flex-col w-full h-full">
              {/* Header */}
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 hidden sm:block">
                    <h3 className="font-display font-extrabold text-[#081C3A] text-xs leading-tight">
                      Edit Full Mouth Rehabilitation CMS
                    </h3>
                    <p className="text-slate-500 text-[10px] font-medium mt-0.5 truncate flex items-center gap-1">
                      <span className="font-mono text-slate-700">{editingService.id}</span>
                    </p>
              ...
              <div className="flex-1 overflow-y-auto bg-slate-50/50 p-6">
                <div className="max-w-6xl mx-auto pb-12">
                  <FullMouthRehabCms onSaveSuccess={loadServicesList} />
                </div>
              </div>
            </div>
          ) : editingService.slug === 'invisible-aligners' || editingService.slug === 'clear-aligners' || editingService.id === 'aligners-srv' || editingService.id === 'aligners' ? (
            /* Custom Full-Scale CMS Editor for Invisible Aligners */
            <div className="relative bg-white flex-grow flex flex-col w-full h-full">
              {/* Header */}
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
                <div className="flex items-center gap-3">
              ...
              <div className="flex-1 overflow-y-auto bg-slate-50/50 p-6">
                <div className="max-w-6xl mx-auto pb-12">
                  <InvisibleAlignersCms onSaveSuccess={loadServicesList} />
                </div>
              </div>
            </div>
          ) : editingService.slug === 'smile-makeover' || editingService.id === 'smile-srv' || editingService.id === 'smile' ? (
            /* Custom Full-Scale CMS Editor for Smile Makeover */
            <div className="relative bg-white flex-grow flex flex-col w-full h-full">
              {/* Header */}
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
                <div className="flex items-center gap-3">
