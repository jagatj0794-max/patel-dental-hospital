...
import { 
  ...
  Phone, MessageSquare, Star, Eye, ShieldCheck, Award, MapPin, Clock, Mail,
...
// Images
import imgCrownsBridges from '../assets/images/crowns_bridges_1780610933368.png';
...
interface CrownsBridgesProps {
  setCurrentPage: (page: PageId) => void;
  openAppointmentModal: (preselectedTreatment?: string) => void;
}

export default function CrownsBridges({ setCurrentPage, openAppointmentModal }: CrownsBridgesProps) {
      ...
      try {
        ...
        if (active) {
          const filtered = allServices
            .filter(item => item.slug !== 'crowns-bridges' && item.slug !== 'crowns-and-bridges' && item.is_active)
            .slice(0, 3);
          setRelatedServices(filtered);
        }
      } catch (err) {
        console.error('Failed to load related services in Crowns & Bridges page:', err);
      }
    };
    fetchRelated();
    return () => {
  ...
  const handleBookClick = () => {
    openAppointmentModal('Crowns & Bridges');
  };

  const getWhatsAppUrl = () => {
    const text = `Hi Patel Dental Hospital, I'm interested in booking a consultation for Crowns & Bridges. Please let me know the next available slot!`;
  ...
  const crownsBridgesFaqs = [
    {
      id: 1,
      question: "What is the primary difference between a dental crown and a dental bridge?",
      answer: "A dental crown is an individual custom cap designed to encase and protect a single damaged or weakened natural tooth, or to top a dental implant. A dental bridge, on the other hand, is used to replace one or more completely missing teeth. It spans the empty gap, anchoring securely to the healthy natural teeth or implants on either side."
    },
    {
      id: 2,
      question: "How long do Crowns & Bridges usually last, and how do I care for them?",
      answer: "With proper clinical design and standard oral hygiene, crowns and bridges routinely last between 10 to 15 years or more. To care for them, simply brush twice daily, use floss or interdental brushes to clean beneath the bridge structure, and attend regular six-month dental check-ups."
    },
    {
      id: 3,
      question: "Are metal-free Zirconia crowns better than metal-fused ceramic crowns?",
      answer: "Yes, metal-free Zirconia crowns offer exceptional benefits. They are highly biocompatible, match the natural translucent light-reflecting glaze of tooth enamel, and prevent any dark metallic line near the gums. Additionally, they are completely safe for medical MRI scans since they contain no magnetic components."
    },
    {
      id: 4,
      question: "Is the tooth preparation and placement process painful?",
      answer: "Not at all. The preparation of the anchoring teeth is completed under highly localized, modern computerized anesthesia to ensure a pain-free experience. After preparation, a comfortable temporary crown or bridge is placed to protect the teeth until your custom permanent prosthesis is fabricated."
    },
    {
      id: 5,
      question: "How many visits are required to complete a Crown or Bridge treatment?",
      answer: "The treatment is typically completed in just 2 quick, painless clinical visits. The first visit involves tooth preparation, shade matching, accurate impressions, and temporary restoration placement. The second visit involves permanently checking the fit, alignment, bite harmony, and fixing the crown or bridge using advanced adhesive resin cement."
    }
  ];

  return (
    <div id="crowns-bridges-page-view" className="relative pt-[72px] bg-[#FAFAFC]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-2.5">
                <span className="text-[#0D9488] font-bold text-[11px] sm:text-[12px] tracking-wider uppercase block">
                  PATEL DENTAL HOSPITAL – RESTORATIVE EXCELLENCE CENTER
                </span>
              ...
              <div className="text-slate-600 text-[14.5px] sm:text-[15.5px] font-medium leading-relaxed space-y-4 font-sans">
                ...
                <p>
                  They restore the appearance, function, alignment and strength of damaged or missing teeth, helping you regain a healthy smile and comfortable chewing.
                </p>
              </div>
            ...
            >
              <div className="rounded-[20px] overflow-hidden aspect-video relative shadow-[0_15px_45px_rgba(8,28,58,0.1)] border border-slate-150 bg-slate-50">
                <img
                  src={imgCrownsBridges}
                  alt="Crowns & Bridges Restorations"
              ...
              <p className="text-center text-slate-500 text-xs sm:text-sm font-semibold font-sans leading-relaxed italic bg-teal-50/40 py-2.5 px-4 rounded-xl border border-teal-500/10">
                Restore Missing Teeth with Natural Looking Crowns & Bridges.
              </p>
            </motion.div>
      ...
      {/* SECTION 2: What are Crowns & Bridges? (Premium introduction section) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              className="bg-[#FAFAFC] p-8 rounded-3xl border border-slate-100 shadow-3xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="h-10 w-10 rounded-xl bg-[#0D9488]/10 text-[#0D9488] flex items-center justify-center font-bold text-sm">
                    01
                  </span>
                  <span className="text-[10px] uppercase font-black tracking-wider text-[#0D9488] bg-[#0D9488]/5 px-2.5 py-1 rounded-md">
                    Crown (Prosthetic Cap)
                  </span>
                </div>
                
                <h3 className="font-display font-extrabold text-[#081C3A] text-xl tracking-tight">
                  Dental Crown
                </h3>
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex items-start space-x-3 text-slate-700">
                    ...
                    <span className="text-sm font-medium font-sans">Covers a damaged tooth like a protective cap.</span>
                  </div>
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Restores natural appearance, shape, colour and alignment.</span>
                  </div>
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Protects structural integrity and reinforces weak tooth structures.</span>
                  </div>
                </div>
              </div>
              <div className="text-[10px] font-mono text-gray-400 border-t border-slate-200/50 pt-3 uppercase tracking-wider">
                Individual Restorative Standard
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="h-10 w-10 rounded-xl bg-[#0EA5C6]/10 text-[#0EA5C6] flex items-center justify-center font-bold text-sm">
                    02
                  </span>
                  <span className="text-[10px] uppercase font-black tracking-wider text-[#0EA5C6] bg-[#0EA5C6]/5 px-2.5 py-1 rounded-md">
                    Bridge (Span Restoration)
                  </span>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0EA5C6] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Replaces one or more missing teeth completely.</span>
                  </div>
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0EA5C6] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Prevents adjacent teeth from tilting or shifting over time.</span>
                  </div>
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0EA5C6] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Helps maintain proper bite force balance and jaw joint function.</span>
                  </div>
                  <div className="flex items-start space-x-3 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-[#0EA5C6] shrink-0 mt-0.5" />
                    <span className="text-sm font-medium font-sans">Reduces the risk of painful TM Joint (temporomandibular) problems.</span>
                  </div>
                </div>
              </div>
              <div className="text-[10px] font-mono text-gray-400 border-t border-slate-200/50 pt-3 uppercase tracking-wider">
                Multi-unit Prosthesis Standard
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-[#FAFAFC] border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-[#0D9488] font-bold text-xs uppercase tracking-widest block mb-2">Material Science</span>
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#081C3A] tracking-tight">
              Materials Used
            </h2>
            <div className="h-[2px] w-12 bg-gradient-to-r from-[#11B5D8] to-[#0EA5C6] mx-auto rounded-full mt-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Material 1: Metal Fused Ceramic */}
            <motion.div
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.4 }}
              className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
                <span className="inline-block text-[10px] uppercase font-black tracking-wider text-[#0D9488] bg-[#0D9488]/5 px-2.5 py-1 rounded-md">
                  PFM STANDARD
                </span>
                <h3 className="font-display font-extrabold text-[#081C3A] text-lg tracking-tight">
                  Metal Fused Ceramic Crowns
                </h3>
                <p className="text-slate-600 text-sm leading-relaxed font-sans font-medium">
                  A highly durable, traditional restoration featuring a ceramic outer layer bonded to a sturdy alloy inner coping, offering dependable bite strength and reliable aesthetic coverage.
                </p>
              </div>
              <div className="text-[9px] font-mono text-gray-400 mt-8 pt-3 border-t border-slate-100 uppercase tracking-widest">
                Restorative Code: MAT-PFM
              </div>
            </motion.div>

            {/* Material 2: Metal Free Zirconia */}
            <motion.div
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.4, delay: 0.1 }}
              className="bg-white p-8 rounded-3xl border border-teal-500/10 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
                <span className="inline-block text-[10px] uppercase font-black tracking-wider text-teal-600 bg-teal-50 px-2.5 py-1 rounded-md">
                  PREMIUM BIOMATERIAL
                </span>
                <h3 className="font-display font-extrabold text-[#081C3A] text-lg tracking-tight">
                ...
                <div className="space-y-2.5 pt-2">
                  <div className="flex items-start space-x-2.5 text-slate-700">
                    ...
                    <span className="text-xs font-semibold font-sans">Zirconia provides an exceptionally realistic, natural translucent appearance.</span>
                  </div>
                  <div className="flex items-start space-x-2.5 text-slate-700">
                    <CheckCircle2 className="h-4.5 w-4.5 text-[#0D9488] shrink-0 mt-0.5" />
                    <span className="text-xs font-semibold font-sans">Biocompatible material protecting surrounding gum tissues seamlessly.</span>
                  </div>
                  <div className="flex items-start space-x-2.5 text-slate-700">
                    <CheckCircle2 className="h-4.5 w-4.5 text-[#0D9488] shrink-0 mt-0.5" />
                    <span className="text-xs font-semibold font-sans">Safe for medical MRI scans with absolutely no magnetic effects.</span>
                  </div>
                </div>
              </div>
              <div className="text-[9px] font-mono text-teal-600 mt-8 pt-3 border-t border-teal-50 uppercase tracking-widest">
                Restorative Code: MAT-ZIR
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* SECTION 4: Crowns & Bridges Treatment Planning */}
      <section className="py-16 md:py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-[#0D9488] font-bold text-xs uppercase tracking-widest block mb-2">Painless Workflow</span>
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#081C3A] tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-[#FAFAFC] p-8 rounded-3xl border border-slate-100 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  <span className="text-4xl font-black text-[#0D9488]/20 font-mono">01</span>
                  <span className="text-[10px] uppercase font-black tracking-widest text-[#0D9488] bg-teal-50 px-3.5 py-1.5 rounded-full">
                    First Visit (Preparation)
                  </span>
                </div>
                <h3 className="font-display font-extrabold text-[#081C3A] text-lg mb-4">Initial Preparation & Diagnostics</h3>
                
                <ul className="space-y-3">
                  {[
                    "Gentle tooth preparation and resizing under computerized localized anesthesia.",
                    "Accurate impression capturing using advanced silicone or high-definition intraoral scanner.",
                    "Shed-matching using direct natural lighting and custom color coordinates.",
                    "Protective fluoride varnish application to eliminate underlying sensitivity.",
                    "Fabrication and secure cementation of a comfortable temporary bridge."
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start space-x-3 text-slate-700">
                      <span className="h-5 w-5 rounded-full bg-[#0D9488]/10 text-[#0D9488] flex items-center justify-center text-[10px] font-black shrink-0 mt-0.5">
                        {idx + 1}
                      </span>
                      <span className="text-sm font-medium font-sans leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
              <div className="text-[10px] font-mono text-gray-400 mt-8 pt-3 border-t border-slate-200/50 uppercase tracking-wider">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  <span className="text-4xl font-black text-[#0EA5C6]/20 font-mono">02</span>
                  <span className="text-[10px] uppercase font-black tracking-widest text-[#0EA5C6] bg-cyan-50 px-3.5 py-1.5 rounded-full">
                    Second Visit (Placement)
                  </span>
                </div>
                <h3 className="font-display font-extrabold text-[#081C3A] text-lg mb-4">Permanent Restorative Placement</h3>
                
                <ul className="space-y-3">
                  {[
                    "Removal of temporary and testing the perfect fit of the permanent custom bridge.",
                    "Permanent fixation of the prosthesis utilizing strong bio-compatible resin cement.",
                    "Detailed clinical guidance on optimal oral hygiene maintenance.",
                    "Practical flossing guidance and special bridge-flossing instructions.",
                    "Brushing instructions, tongue cleaning, and antiseptic mouthwash guidance.",
                    "Recommending regular six-month dental follow-ups to maximize restoration longevity."
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start space-x-3 text-slate-700">
                      <span className="h-5 w-5 rounded-full bg-[#0EA5C6]/10 text-[#0EA5C6] flex items-center justify-center text-[10px] font-black shrink-0 mt-0.5">
                        {idx + 1}
                      </span>
                      <span className="text-sm font-medium font-sans leading-relaxed">{item}</span>
                    </li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-3xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow">
              <BeforeAfterSlider
                ...
                beforeLabel="Fractured Front Enamel (Before)"
                afterLabel="Perfect CAD/CAM Crowns (After)"
              ...
              <div className="mt-5 space-y-2">
                ...
                <p className="text-gray-500 font-sans text-xs leading-relaxed">
                  Damaged and chipped anterior teeth prepared and reinforced beautifully with computerized high-aesthetic ceramic dental crowns.
                </p>
              </div>
            </div>

            {/* Case 2: Bridges Cases */}
            <div className="bg-white p-4 sm:p-6 rounded-3xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow">
              <BeforeAfterSlider
                beforeImg={imgCase1Before}
                afterImg={imgCase1After}
                beforeLabel="Missing Anchoring Tooth (Before)"
                afterLabel="Custom Solid Dental Bridge (After)"
                aspectRatioClassName="aspect-[4/3]"
              />
              <div className="mt-5 space-y-2">
                <span className="inline-block text-[10px] uppercase font-black tracking-wider text-[#0D9488] bg-[#0D9488]/5 px-2.5 py-1 rounded-md">
                ...
                <p className="text-gray-500 font-sans text-xs leading-relaxed">
                  Filling space and restoring ideal chewing comfort with a custom-fabricated multi-unit dental bridge secured to healthy neighbors.
                </p>
              </div>
            </div>

            {/* Case 3: Zirconia Crowns */}
            <div className="bg-white p-4 sm:p-6 rounded-3xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow">
              <BeforeAfterSlider
                beforeImg={imgCase2Before}
                afterImg={imgCase2After}
                beforeLabel="Uneven / Discolored Enamel (Before)"
                afterLabel="Premium Metal-Free Zirconia (After)"
                aspectRatioClassName="aspect-[4/3]"
              />
              <div className="mt-5 space-y-2">
                <span className="inline-block text-[10px] uppercase font-black tracking-wider text-[#0D9488] bg-[#0D9488]/5 px-2.5 py-1 rounded-md">
                ...
                <p className="text-gray-500 font-sans text-xs leading-relaxed">
                  Full restorative cosmetic makeover using premium, non-magnetic, medical-grade translucent zirconia crowns for a bright, lifelike smile.
                </p>
              </div>
            </div>

            {/* Case 4: Smile Restoration Cases */}
            <div className="bg-white p-4 sm:p-6 rounded-3xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow">
              <BeforeAfterSlider
                beforeImg={imgSmileBefore}
                afterImg={imgSmileAfter}
                beforeLabel="Anterior Spacing & Wear (Before)"
                afterLabel="Complete Smile Restoration (After)"
                aspectRatioClassName="aspect-[4/3]"
              />
              <div className="mt-5 space-y-2">
                <span className="inline-block text-[10px] uppercase font-black tracking-wider text-[#0D9488] bg-[#0D9488]/5 px-2.5 py-1 rounded-md">
                ...
                <h3 className="font-display font-extrabold text-[#081C3A] text-base">
                  Smile Restoration Cases
                </h3>
                <p className="text-gray-500 font-sans text-xs leading-relaxed">
                  Comprehensive therapeutic rehabilitation restoring natural alignment, ideal occlusion, and beautiful symmetry.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-[#0EA5C6]/5 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-500 font-sans text-xs sm:text-sm mt-2 leading-relaxed">
              Watch this educational case study video to visualize the exact scientific process of placing dental crowns and bridges at our hospital.
            </p>
            <div className="h-[2px] w-12 bg-gradient-to-r from-[#11B5D8] to-[#0EA5C6] mx-auto rounded-full mt-4" />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#081C3A] text-white rounded-3xl p-8 sm:p-12 md:p-16 shadow-xl relative overflow-hidden space-y-6 max-w-5xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto text-center space-y-4 relative z-10">
              <span className="inline-flex items-center gap-1 bg-[#0D9488] text-white text-[10px] font-black uppercase tracking-widest px-3.5 py-1.5 rounded-full leading-none">
                Save Up To 50%
              </span>
              ...
              <p className="text-slate-350 text-xs sm:text-sm leading-relaxed">
                Restore full chewing ability and correct dental aesthetics affordably. Schedule a detailed initial diagnostic check with our clinical specialists today.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10 pt-4">
              ...
              <a
                href={`https://wa.me/${whatsappRaw}?text=Hi%20Patel%20Dental%20Hospital,%20I'm%20interested%20in%20learning%20more%20about%20the%20Crowns%20%26%20Bridges%20treatments%20and%20packages.`}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-extrabold text-[#081C3A] tracking-tight">
                Our Restorative Care Facilities
              </h2>
              <p className="text-gray-600 font-sans text-sm leading-relaxed">
                Patel Dental Hospital is equipped with highly customized treatment rooms, sterile environment chambers, and cutting-edge computerized CAD/CAM scanning systems. Our top priority is your comfortable experience, ensuring complete hygiene, precise alignment, and natural-fitting dental restorations.
              </p>
              <div className="space-y-3.5 pt-2">
                <div className="flex items-start space-x-3 text-slate-700">
                  <CheckCircle2 className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                  <span className="text-xs sm:text-sm font-semibold font-sans">100% Sterile Restorations & Surgical Rooms</span>
                </div>
                <div className="flex items-start space-x-3 text-slate-700">
                  <CheckCircle2 className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                  <span className="text-xs sm:text-sm font-semibold font-sans">Computerized Intraoral High-Definition Scanning</span>
                </div>
                <div className="flex items-start space-x-3 text-slate-700">
                  <CheckCircle2 className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                  <span className="text-xs sm:text-sm font-semibold font-sans">In-house Dental Lab Partnerships for Rapid Fabrication</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-slate-50">
                <img
                  src={patelClinicInterior}
                  alt="Patel Dental Hospital Clinical Environment"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#081C3A]/90 backdrop-blur-xs p-4 rounded-xl text-white text-center">
                  <p className="text-[11px] font-mono uppercase tracking-widest text-[#0D9488]">STATE-OF-THE-ART CLINICAL EXCELLENCE CENTER</p>
                  <p className="text-xs font-sans text-gray-300 mt-1">Providing safe, comfortable and pristine dental care since generations</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-[#FAFAFC] border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 font-sans text-xs sm:text-sm mt-2 leading-relaxed">
              Listen to the actual clinical experience shared directly by our happy crowns & bridges patients.
            </p>
            <div className="h-[2px] w-12 bg-gradient-to-r from-[#11B5D8] to-[#0EA5C6] mx-auto rounded-full mt-4" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-100 p-4 shadow-xl">
              <div className="aspect-video w-full bg-slate-900 rounded-2xl relative overflow-hidden shadow-inner">
                {activeVideos['patient-review-vid'] ? (
                  <iframe
                    className="w-full h-full border-0 absolute inset-0 z-10"
                    src="https://www.youtube.com/embed/cyai6CjMD0s?autoplay=1&rel=0"
                    title="Crowns & Bridges Patient Review Testimonial"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowFullScreen
                    loading="lazy"
                  ></iframe>
                  ...
                  >
                    <img
                      ...
                      alt="Patient Testimonial Review Thumbnail"
                      className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-103"
                      loading="lazy"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 bg-black/25 group-hover:bg-black/35 transition-colors duration-300 pointer-events-none" />
                    <div className="absolute z-20 flex items-center justify-center w-14 h-14 rounded-full bg-white/95 text-[#0D9488] shadow-md group-hover:scale-110 group-hover:bg-[#0D9488] group-hover:text-white transition-all duration-300 pointer-events-none">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-3xs relative">
                <span className="text-4xl text-[#0D9488]/15 font-serif absolute top-4 left-4">“</span>
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-[#081C3A] font-medium text-xs sm:text-sm leading-relaxed font-sans italic">
                    "I had two missing teeth and got a customized Zirconia bridge at Patel Dental Hospital. The fit is incredibly natural, and I can chew comfortably again. Dr. Vipul Patel and his team are highly professional!"
                  </p>
                  <div>
                    <h4 className="text-xs font-black text-[#081C3A]">Nilesh Shah</h4>
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Happy Patient</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-3xs relative">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-[#081C3A] font-medium text-xs sm:text-sm leading-relaxed font-sans italic">
                    "Excellent crowns & bridges treatment. Fast, painless, and very affordable with state-of-the-art technology. Highly recommended hospital in Rajkot!"
                  </p>
                  <div>
                    <h4 className="text-xs font-black text-[#081C3A]">Priti Vora</h4>
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Satisfied Restoration</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* SECTION 11: Hospital Information */}
      <section className="py-16 md:py-24 bg-[#FAFAFC] border-t border-gray-100">
      ...
      {/* SECTION 12: Our Services (Related Services clickable list) */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
              Find professional answers to common questions about our Crowns & Bridges.
            </p>
          </div>

          <div className="space-y-3">
            {crownsBridgesFaqs.map((faq) => {
      ...
      <section className="py-16 md:py-20 bg-[#081C3A] text-white text-center relative overflow-hidden border-t border-slate-800">
        ...
        <div className="max-w-2xl mx-auto px-4 relative z-10 space-y-6">
          ...
          <p className="text-gray-350 text-xs sm:text-sm leading-relaxed max-w-md mx-auto font-sans">
            Experience world-class crowns & bridges treatments with high quality standards. Contact us to schedule your visit.
          </p>
